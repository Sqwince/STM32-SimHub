...
#define GAMEPAD_AXIS_04_EXPONENTIALFACTOR 1 		//{"Name":"GAMEPAD_AXIS_04_EXPONENTIALFACTOR","Title":"Steering axis exponential correction","DefaultValue":"1","Type":"double","Condition":"GAMEPAD_AXIS_04_ENABLED>0","dMin":0.1,"dMax":1.9}
#endif
...
//STM32 JOYSTICK
#if defined(ARDUINO_OPENFFBOARD_F407VG)
	#include "STM32Gamepad.h"

	STM32Gamepad Joystick;

	#if (GAMEPAD_AXIS_01_ENABLED == 1)
		STM32GamepadAxis SHGAMEPADAXIS01(GAMEPAD_AXIS_01_PIN,0,GAMEPAD_AXIS_01_MINVALUE,GAMEPAD_AXIS_01_MAXVALUE,GAMEPAD_AXIS_01_SAMPLING,GAMEPAD_AXIS_01_EXPONENTIALFACTOR);
	#endif
	#if (GAMEPAD_AXIS_02_ENABLED == 1)
		STM32GamepadAxis SHGAMEPADAXIS02(GAMEPAD_AXIS_02_PIN,1,GAMEPAD_AXIS_02_MINVALUE,GAMEPAD_AXIS_02_MAXVALUE,GAMEPAD_AXIS_02_SAMPLING,GAMEPAD_AXIS_02_EXPONENTIALFACTOR);
	#endif
	#if(GAMEPAD_AXIS_03_ENABLED == 1)
		STM32GamepadAxis SHGAMEPADAXIS03(GAMEPAD_AXIS_03_PIN,2,GAMEPAD_AXIS_03_MINVALUE,GAMEPAD_AXIS_03_MAXVALUE,GAMEPAD_AXIS_03_SAMPLING,GAMEPAD_AXIS_03_EXPONENTIALFACTOR);
	#endif
	#if(GAMEPAD_AXIS_04_ENABLED == 1)
		STM32GamepadAxis SHGAMEPADAXIS04(GAMEPAD_AXIS_04_PIN,3,GAMEPAD_AXIS_04_MINVALUE,GAMEPAD_AXIS_04_MAXVALUE,GAMEPAD_AXIS_04_SAMPLING,GAMEPAD_AXIS_04_EXPONENTIALFACTOR);
	#endif
...
// ----------------------------------------------------------------------------------------------------------
#define ENABLED_BUTTONS_COUNT 12 //{"Group":"Additional Buttons","Name":"ENABLED_BUTTONS_COUNT","Title":"Additional buttons (directly connected to the arduino, 12 max) buttons count","DefaultValue":"0","Type":"int","Max":12}
#ifdef INCLUDE_BUTTONS

#define BUTTON_PIN_1 22		  //{"Name":"BUTTON_PIN_1","Title":"1'st Additional button digital pin","DefaultValue":"3","Type":"pin;Button 1","Condition":"ENABLED_BUTTONS_COUNT>=1"}
...
#define BUTTON_PIN_3 24		  //{"Name":"BUTTON_PIN_3","Title":"3'rd Additional button digital pin","DefaultValue":"3","Type":"pin;Button 3","Condition":"ENABLED_BUTTONS_COUNT>=3"}
...
#define BUTTON_PIN_4 25		  //{"Name":"BUTTON_PIN_4","Title":"4'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 4","Condition":"ENABLED_BUTTONS_COUNT>=4"}
...
#define BUTTON_PIN_5 26		  //{"Name":"BUTTON_PIN_5","Title":"5'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 5","Condition":"ENABLED_BUTTONS_COUNT>=5"}
...
#define BUTTON_PIN_6 27		  //{"Name":"BUTTON_PIN_6","Title":"6'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 6","Condition":"ENABLED_BUTTONS_COUNT>=6"}
...
#define BUTTON_PIN_7 28		  //{"Name":"BUTTON_PIN_7","Title":"7'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 7","Condition":"ENABLED_BUTTONS_COUNT>=7"}
...
#define BUTTON_PIN_8 29		  //{"Name":"BUTTON_PIN_8","Title":"8'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 8","Condition":"ENABLED_BUTTONS_COUNT>=8"}
...
#define BUTTON_PIN_9 30		  //{"Name":"BUTTON_PIN_9","Title":"9'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 9","Condition":"ENABLED_BUTTONS_COUNT>=9"}
...
#define BUTTON_PIN_10 31	   //{"Name":"BUTTON_PIN_10","Title":"10'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 10","Condition":"ENABLED_BUTTONS_COUNT>=10"}
...
#define BUTTON_PIN_11 32	   //{"Name":"BUTTON_PIN_11","Title":"11'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 11","Condition":"ENABLED_BUTTONS_COUNT>=11"}
...
#define BUTTON_PIN_12 33	   //{"Name":"BUTTON_PIN_12","Title":"12'th Additional button digital pin","DefaultValue":"3","Type":"pin;Button 12","Condition":"ENABLED_BUTTONS_COUNT>=12"}
...
#endif
#if (GAMEPAD_AXIS_04_ENABLED == 1) && defined(ARDUINO_OPENFFBOARD_F407VG) //STM32 only
...
#include "SHRGBLedsNeoPixel.h"
	...
	{
		shRGBMatrixWS2812B.begin(64, WS2812B_MATRIX_LEFTRIGHTMIRROR, WS2812B_MATRIX_SERPENTINELAYOUT, WS2812B_MATRIX_SERPENTINELAYOUTREVERSE, false);
	}
#endif
#ifdef INCLUDE_DM163_MATRIX
	...
	if (DKMOTOR_SHIELDSCOUNT > 0)
		shShakeitDKMotorShield.begin(DKMOTOR_USEHUMMINGREDUCING);
#endif
#ifdef INCLUDE_SHAKEITADASHIELD
...
#endif
#if (GAMEPAD_AXIS_04_ENABLED == 1) && defined(ARDUINO_OPENFFBOARD_F407VG) //STM32 only
	SHGAMEPADAXIS04.SetJoystick(&Joystick);
#endif
#ifdef INCLUDE_GAMEPAD
	Joystick.sendState();
#endif
...
#if defined(ARDUINO_OPENFFBOARD_F407VG)  //TODO: may be redundant because sendState also calls update, need to check if update is needed to be called here or not
	Joystick.update();
#endif
	Joystick.sendState();
}
...
void loop()
{
	...
	if (millis() - lastSerialActivity > 10000)
	{ // was 5000 timeout
		Command_Shutdown();
	}
}
